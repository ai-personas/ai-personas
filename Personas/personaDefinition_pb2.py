...
_PERSONA_DNA_LAYERCONVOLUTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='borderMode', full_name='persona.Persona.DNA.LayerConvolution.borderMode', index=2,
