...
_PERSONA_ENVIRONMENT_INFORMATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='connectedLayerName', full_name='persona.Persona.Environment.Information.connectedLayerName', index=1,
